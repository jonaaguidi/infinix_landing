...
const About = () => {
  ...
  useEffect(() => {
    const typed = new Typed(el.current, {
      strings: [
        'Fortalecendo o sucesso digital por meio de soluções tecnológicas abrangentes.',
        'Cresça sua marca conosco!',
        'Soluções ágeis para desenvolvimentos tecnológicos...',
        "Vamos tornar o seu produto uma realidade..."
      ],
