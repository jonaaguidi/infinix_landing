            ...
            <div className="container content-space-b-2">
                <div className="row">
                    <div className="col-lg-12">
                        <h1 className="title-bold-1 infinix-title-black text-center mb-lg-5 wow fadeInUpSmall" data-wow-duration="1s" data-wow-delay=".2s"> Confiável por <span className="selected-whitebg">Líderes do setor</span>: <br />Parceiros e clientes</h1>
                    </div>
                </div>
            </div>
