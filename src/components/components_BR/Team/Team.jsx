        ...
        <div className="container content-space-b-0">
          <div className="row">
            <div className="col-lg-12">
              <h1 id="team_title" className="title-bold-1 infinix-title-black text-center mb-lg-5 wow fadeInUpSmall" data-wow-duration="1s" data-wow-delay=".2s"> Nossa <span className="selected-whitebg">equipe de profissionais</span></h1>
            </div>
          </div>
        </div>
      </section>
