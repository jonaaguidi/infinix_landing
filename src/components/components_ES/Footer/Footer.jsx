...
import designRush from "../../../../public/imgs/Footer/clutch.png";
                    ...
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="content-space-b-lg-1">
                                <h1 className="text-white" data-aos-delay="100" data-aos-duration="1000" data-aos="fade-in">Póngase en contacto con nuestro <br /> equipo de ventas</h1>
                                <p className="text-color-light-gray">Conéctese con nuestro equipo para obtener más información sobre nuestros servicios.</p>
                            </div>
                        ...
                        <div className="col-lg-6 ps-lg-5 mt-10 mt-lg-0">
                            <form id="holding-contact-form-index" data-aos="fade-in" data-aos-delay="400" data-aos-duration="1000">
                                <div className="mb-4">
                                    <input type="text" className="form-control form-control-lg" name="formName" id="formName" placeholder="Nombre" aria-label="First" />
                                </div>
                                <div className="mb-4">
                                    <input type="email" className="form-control form-control-lg" name="formEmail" id="formEmail" placeholder="Correo" aria-label="Email" />
                                </div>
                                <div className="mb-4">
                                    <input type="text" className="form-control form-control-lg" name="formCompany" id="formCompany" placeholder="Empresa" aria-label="Company" />
                                </div>
                                <div className="mb-4">
                                    <textarea className="form-control form-control-lg" name="formMessage" id="formMessage" placeholder="Mensaje" aria-label="Message" rows="4"></textarea>
                                </div>
                                <div className="mb-2">
                                    <button type="submit" className="btn-white">Enviar</button>
                                </div>
                            </form>
                        </div>
                    </div>
