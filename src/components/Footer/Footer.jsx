                    ...
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="content-space-b-lg-1">
                                <h1 className="text-white wow fadeIn" data-wow-duration="1s" data-wow-delay=".1s">Contact our <br /> sales team</h1>
                            ...
                            <ul className="list-checked list-checked-success mb-0 pe-lg-6">
                                <li className="list-checked-item wow fadeIn" data-wow-duration="1s" data-wow-delay=".2s"><b>Miami</b>: 360 NE 75 st. Miami, Suite #127, Florida 33138 United States.</li>
                                <li className="list-checked-item arrow-white wow fadeIn" data-wow-duration="1s" data-wow-delay=".3s"><b>New York</b>: 175 Varick St. New York, NY. 10013. United States</li>
                                <li className="list-checked-item arrow-white wow fadeIn" data-wow-duration="1s" data-wow-delay=".3s"><b>Buenos Aires</b>: Av.Rivadavia 18451, Buenos Aires. Argentina</li>
                                <li className="list-checked-item wow fadeIn" data-wow-duration="1s" data-wow-delay=".4s"><b>Reach us</b>: <a className="infinix-text-white" href="mailto:info@infinixnft.com">info@infinixsoft.com</a></li>
                                <li className="list-checked-item arrow-pink wow fadeIn" data-wow-duration="1s" data-wow-delay=".5s"><b>+1 (877) 789 8761</b></li>
                            </ul>
                        </div>
                        <div className="col-lg-6 ps-lg-5 mt-10 mt-lg-0">
                            <form id="holding-contact-form-index" className="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">
                                <div className="mb-4">
            ...
            <div className="container border-top-gray content-space-t-2 content-space-b-1">
                <div className="row">
                    <div className="col-lg-3 mb-5 mb-md-0">
                        <ul className="list-unstyled list-py-1 mb-0 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                        ...
                        <ul className="list-unstyled list-py-1 mb-0 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s">
                    ...
                    <div className="col-lg-2 mb-5 mb-md-0">
                        <ul className="list-unstyled list-py-1 mb-0 wow fadeIn prensa" data-wow-duration="1s" data-wow-delay="0.4s">
                    ...
                    <div className="col-lg-6 text-center text-lg-start mt-4">
                        <ul className="list-inline mb-0">
                            <li className="list-inline-item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                            ...
                            <li className="list-inline-item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.6s">
                            ...
                            <li className="list-inline-item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.7s">
